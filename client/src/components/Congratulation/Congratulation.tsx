...
function Congratulation(prop: proptype) {
  ...
  return (
    <>
      <div
        className="fixed flex justify-center items-center w-full min-h-screen top-0  left-0 bg-[rgba(24,35,37,0.4)] z-[2000] p-[40px_15px]"
        onClick={() => {
          setCongrats(false);
        }}
      >
        <img
          src={congratPaper}
          alt="Congrats Paper"
          className="w-[654px] max-w-full absolute z-[2001]"
          onClick={(e) => e.stopPropagation()}
        />
        <div
          className="w-[570px] h-[342px] p-10 bg-white rounded-3xl flex-col justify-start items-start gap-[25px] inline-flex relative z-[2001]"
          onClick={(e) => e.stopPropagation()}
        >
          <img
            src={cclose}
            alt="CClose"
            className="absolute right-3 top-3 w-10"
          ...
          <div className="text-[#182224] max-w-[390px] lg:text-[32px] text-[20px] font-medium font-['Inter'] lg:leading-[38.72px]">
            ...
            <br /> It is very important for us.
          </div>
