...
function Navbar() {
  const navOpen = useSelector(
    (store: { ui: { navOpen: boolean } }) => store.ui.navOpen
  );
  ...
  return (
    <>
      {navOpen && (
        <div className="top-0 mob-nav min-h-screen z-[1001] w-full">
          <div className="w-[320px] mob-nav-ani p-4 min-h-screen max-w-full bg-white flex flex-col ">
